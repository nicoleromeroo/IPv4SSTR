package hm.edu.dako.echoUDPApp;

import hm.edu.dako.connection.udp.UdpClientConnection;
import hm.edu.dako.connection.udp.UdpClientConnectionFactory;
...
public class EchoUDPClient {
    ...
    private void connect() throws Exception {
        try {
            con = (UdpClientConnection) udpFactory.connectToServer("localhost", 50000, 0,
                    400000, 400000);
